...
//     { title: 'Job', start: '', allDay: false, id: 1 },
//     { title: 'Job', start: '', allDay: false, id: 2 },
//     { title: 'Job', start: '', allDay: false, id: 3 },
//     { title: 'Job', start: '', allDay: false, id: 4 },
//     { title: 'Job', start: '', allDay: false, id: 5 },
//     { title: 'Job', start: '', allDay: false, id: 6 },
//     { title: 'Job', start: '', allDay: false, id: 7 },
//     { title: 'Job', start: '', allDay: false, id: 8 },
//     { title: 'Job', start: '', allDay: false, id: 9 },
//     { title: 'Job', start: '', allDay: false, id: 10 },
//   ]);
...
//   function handleEditEventTitle(id: number, value: string) {
//     setEvents(events.map(event => (event.id === id ? { ...event, title: value } : event)));
//     setAllEvents(allEvents.map(event => (event.id === id ? { ...event, title: value } : event)));
//   }
...
//       title: data.draggedEl.getAttribute("title") || "",
//       allDay: data.allDay,
//       id: new Date().getTime()
//     };
...
//               />
//             </div>
//             <div id="draggable-el" className="ml-8 w-full border p-2 rounded-md mt-16 lg:h-1/2 bg-white shadow-lg dark:bg-[#161616]">
